...
The provider-adapter approval is deliberately narrow: preserve information already present at the adapter boundary. New provider telemetry mappings still require human review. Introducing a new signal solely to prove zero model requests is outside v1.
