...
- Detect repeated tool calls, repeated failed tool calls, high cumulative tool result volume, high tool failure rate, and dominant tool usage from those summaries
